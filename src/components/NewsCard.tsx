...
export function NewsCard({ news, ticker, logo }: NewsCardProps) {
  ...
  return (
    <div 
      ...
      className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-200 flex flex-col min-h-[200px]"
    ...
    >
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2">
            {logo ? (
              ...
              <span 
                className="inline-flex items-center px-2 pt-1 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200"
        ...
        {/* Headline */}
        <h4 
          className="text-sm font-semibold text-gray-900 mb-3 leading-tight line-clamp-2"
        ...
        <div id={`article-${news.id}`} className="sr-only">
          {summary}
        </div>
        ...
        <div className="flex items-center justify-between mt-auto pt-2">
          ...
          {news.url && (
            <button
              ...
              className="inline-flex items-center space-x-1.5 px-3 py-1.5 text-xs font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 rounded-full hover:bg-primary-100 dark:hover:bg-primary-900/40 transition-colors"
